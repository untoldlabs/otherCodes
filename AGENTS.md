...
- `vtracer` has no CLI binary — use the Python API: `import vtracer; vtracer.convert_image_to_svg_py(path, colormode="binary", ...)`
...
- **Annotation:** 11 of 13 photos segmented (prototype batch)
...
We are making a website that will display visualisations of data science analysis. The analysis is of "tag" style graffiti. Behind the scenes the graffiti will be uploaded as photos and: 
1. The writing "tag" style graffiti will be segmented from a photo
2. The tag will be turned into a raster and SVG representation
3. metrics will be developed to describe the tag
4. dendrograms and phylogenetics and PCA based approaches will be used to group tags as similar or different, and understand major types of styles and how they itneract with geography. 

Behind the scence conception, this is a bit like pokemon go, but capturing tags made by people in the real world which is far more itneresting than capturing fake animals.
